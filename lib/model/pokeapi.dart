...
class GenerationVii {
  ...
  GenerationVii({this.icons1, this.ultraSunUltraMoon});

  GenerationVii.fromJson(Map<String, dynamic> json) {
    icons1 =
    json['icons1'] != null ? new DreamWorld.fromJson(json['icons1']) : null;
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if (this.icons1 != null) {
      data['icons1'] = this.icons1.toJson();
    }
